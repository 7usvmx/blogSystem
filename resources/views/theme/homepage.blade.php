      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="single-recent-blog-post">
            <div class="thumb">
              <img class="w-100 img-fluid" src="{{ asset("storage/blogs/img/$blog->image") }}" alt="">
              <ul class="thumb-info">
                <li><a href="#"><i class="ti-user"></i>{{ $blog->user->name }}</a></li>
                <li><a href="#"><i class="ti-notepad"></i>{{ $blog->created_at->format('F j, Y') }}</a></li>
          ...
          @endforeach
          @else
          <div class="single-recent-blog-post text-center">
            <h1>No Blogs Yet</h1>
            <center>
