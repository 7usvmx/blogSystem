<head>
  ...
  <link rel="stylesheet" href="{{ asset('theme-assets/vendors/bootstrap/bootstrap.min.css') }}">
  <link rel="stylesheet" href="{{ asset('theme-assets/vendors/fontawesome/css/all.min.css') }}">
  <link rel="stylesheet" href="{{ asset('theme-assets/vendors/themify-icons/themify-icons.css') }}">
  <link rel="stylesheet" href="{{ asset('theme-assets/vendors/linericon/style.css') }}">
